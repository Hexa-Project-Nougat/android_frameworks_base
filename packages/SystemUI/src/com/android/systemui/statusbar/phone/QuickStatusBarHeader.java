...
public class QuickStatusBarHeader extends BaseStatusBarHeader implements
        NextAlarmChangeCallback, OnClickListener, OnUserInfoChangedListener, StatusBarHeaderMachine.IStatusBarHeaderMachineObserver,
	 	EmergencyListener, SignalCallback, OmniJawsClient.OmniJawsObserver {
    ...
    private UpdateWeatherButton mWeatherimage;
    ...
    protected void onFinishInflate() {
        ...
        mWeatherimage = (UpdateWeatherButton) findViewById(R.id.weather_image);
		//TESTING START
